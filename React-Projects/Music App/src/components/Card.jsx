...
const Card = () => {
  ...
  return (
    <Link to={'/song/song'} className=" group h-[52%] w-[20%] relative flex flex-col items-center justify-center bg-none border rounded-2xl ">
      <div popover  className="h-[95%] w-[95%] bg-white/10 blur-md rounded-2xl z-0 absolute"></div>
    ...
    <div className="flex-col flex relative leading-0 w-full px-5">
        ...
        <p className="text-gray-300 mb-5 mt-2 ">singer</p>
        <button onClick={() => {
            navigate('/song/song');
